        ...
        public function render() {
            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                foreach ( $this->field['wbc_demo_imports'] as $section => $imports ) {
                    ...
                    echo '<div class="wrap-importer theme '.$extra_class.'" data-demo-id="'.esc_attr( $section ).'" data-site-url="' . esc_attr(esc_url(get_site_url())) . '" data-nonce="' . $nonce . '" id="' . $this->field['id'] . '-custom_imports">';
